...
<html data-wf-site="5409c89a6774599c3d7eeb34" data-wf-page="5409f21050c3bd3f1b90af2d">
<head>
  <meta charset="utf-8">
  <title>success</title>
    ...
    <div class="w-container centeredcontent">
      <div class="w-row">
        ...
        <div class="w-col w-col-4 loginsection">
          <h3 class="introtext">Tus cursables se han registrado exitosamente</h3>
          <div class="introtext">Gracias por hacer el registro de tus materias cursables. Si tienes alguna duda o quieres hacer algún cambio, puedes acudir con tu director/a de carrera.</div><a class="button submit-button espacioarriba espacioderecha" href="cursablesalumno.php">Ver mis cursables</a>
          <a
          class="button submit-button espacioarriba" href="logout.php">Salir</a>
        </div>
        <div class="w-col w-col-4"></div>
      </div>
    </div>
