...
$currmateria = $_SESSION['materiaconsulta'];
...
<html data-wf-site="5409c89a6774599c3d7eeb34" data-wf-page="540a2a0150c3bd3f1b90b172">
<head>
  <meta charset="utf-8">
  <title>materia - Samuel's Blank Site</title>
      ...
      <div class="w-tabs" data-duration-in="300" data-duration-out="100">
        <div class="w-tab-menu">
          <a class="w-tab-link <?php 
					  if(!(isset($_POST['matricula'])||isset($_POST['clave']))){echo 'w--current';}?> w-inline-block" data-w-tab="Materia">
            <div>Detalles de <?php echo $currmateria;?></div>
          </a>
          <a class="w-tab-link <?php 
        ...
        <div class="w-tab-content espacioabajo">
          <div class="w-tab-pane" data-w-tab="Materia">
            <?php $query = mysql_query("select nombre, idMateria, unidades, Count(c.idmateria) as numalumn from materia m natural join cursablesseleccionadas c where idmateria = '".$currmateria."'"); 
					$row = mysql_fetch_assoc($query);?>
            <div>
              ...
              <div class="w-row">
                <div class="w-col w-col-4">
                  <h4>Clave</h4>
                  <div><?php echo $row['idMateria'];?></div>
                </div>
                <div class="w-col w-col-4">
                  <h4>Unidades</h4>
                  <div><?php echo $row['unidades'];?></div>
                </div>
                <div class="w-col w-col-4">
                  <h4>Alumnos</h4>
                  <div><?php echo $row['numalumn'];?></div>
                </div>
              </div>
            </div>
          </div>
          <div class="w-tab-pane w--tab-active espacioarriba" data-w-tab="Otra Consulta">
            <div class="w-row">
              <div class="w-col w-col-6">
                <div class="w-form">
                  <form class="studentblock" id="email-form" name="email-form" data-name="Email Form" method="post" action="materia.php">
